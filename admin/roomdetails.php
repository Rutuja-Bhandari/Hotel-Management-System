...
<html lang="en">
  <head>
    ...
    <title>Checkin Checkout Details</title>
  </head>
  <body>
    ...
    <nav class="navbar navbar-expand-lg   ">
      <a class="navbar-brand navcolor" href="#">Navbar</a>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <a class="btn btn-primary" href="membershipallbooking.php" role="button" >Booking Details</a>
          </div>
          </div>
        </div>
      </nav>
    ...
    <div class="panel-body booking">
                      ...
                      <th>Status</th>
									...
									<?php
									$tsql = "select membership_id,first_name,last_name,arrival_date,leaving_date,membership_record.room_no,status from membership,membership_record where membership.membership_id=membership_record.member_id";
